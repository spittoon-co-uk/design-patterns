...
console.log(beverage1.getSize(), beverage1.getDescription(), ': £'+beverage1.cost().toFixed(2));

let beverage2 = new Decaf;
beverage2.setSize("Venti");
beverage2 = new Mocha(beverage2);
console.log(beverage2.getSize(), beverage2.getDescription(), ': £'+beverage2.cost().toFixed(2));
...
beverage3 = new Mocha(beverage3);
beverage3 = new Soy(beverage3);
console.log(beverage3.getSize(), beverage3.getDescription(), ': £'+beverage3.cost().toFixed(2));

let beverage4 = new HouseBlend;
beverage4.setSize("Venti");
beverage4 = new Whip(beverage4);
beverage4 = new SteamedMilk(beverage4);
console.log(beverage4.getSize(), beverage4.getDescription(), ': £'+beverage4.cost().toFixed(2));
...
console.log(beverage5.getSize(), beverage5.getDescription(), ': £'+beverage5.cost().toFixed(2));